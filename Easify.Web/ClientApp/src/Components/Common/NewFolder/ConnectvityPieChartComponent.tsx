    ...
    render() {
        return (
            <div className={`pie-chart ${this.props.isResponsive ? "" : "d-flex justify-content-center"}`}>
                ...
                {this.props.isConnectivity && (this.props?.chartData === undefined || this.props?.chartData?.length === 0) && <div className={`${this.props.isResponsive ? "" : "mx-3"} no-data-message`}>No Charts data available</div>}
            </div>
        );
    }
}
