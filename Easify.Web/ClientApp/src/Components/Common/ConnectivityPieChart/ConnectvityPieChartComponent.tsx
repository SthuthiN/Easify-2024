    ...
    render() {
        return (
            <div className={`pie-chart ${this.props.isResponsive ? "" : "d-flex justify-content-center"}`}>
                ...
                { <React.Fragment>
                        <div >
                            <PieChart onMouseMove={(e) => this.onPieEnter(e)} className={`col  ${ this.props.isFullScreen ? "fullscreen-capability-chart" : "capability-chart" }`} width={this.props.isFullScreen ? 385 : 298} height={this.props.isFullScreen ? 310 : 195} margin={{ top: 0, right: 30, left: 0, bottom: 5 }}>
                                <Pie
                                    startAngle={60}
                                    endAngle={-360}
                                    dataKey="value"
                                ...
                                data={this.props.chartData && this.props.chartData }
                                    cx={this.props.isFullScreen ? "40%" : "60%"}
                                    cy="50%"
                ...
                { (this.props.chartData === undefined || this.props.chartData.length === 0) && <div className={`${this.props.isResponsive ? "" : "mx-3"} no-data-message`}>No Charts data available</div>}
            </div>
        );
    }
}
